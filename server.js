...
const itemsDatabase = [
    {
        ...
        price: 23,
        dateOfPosting: "2017-07-21T17:32:28Z",
        deliveryType: "shipping",
        seller: {
          name: "Jane Doe",
          email: "jdoe@mails.com",
...
const usersDatabase = [
    ...
    function getUserByName (username){
		return usersDatabase.find(this.username.isEqual(username));
    }
];
...
(req, res) => {
    ...
    if (!req.body.title) {
        ...
        return res.status(400).json({
            "message": "Delivery must be either pickup or delivery"
        });
    }

    // call function to add item to database 
    itemsDatabase.addItem(req.user.userId, req.body.title, req.body.description, req.body.category, req.body.location, req.images, req.body.price, req.body.deliveryType);
